...
//Captura de valores
$total_km = Yii::$app->request->get('total_km'); 
...
$detalle_distancia_envio = Yii::$app->request->get('detalle_distancia_envio'); 
...
<table style="border: solid 1px grey;">
    ...
    <tr>
        ...
        <td style="width: 200px; border: solid 1px grey; text-align: center;"><?= $detalle_distancia_envio.' ('.$total_km.' km)' ?></td>        
        <td style="width: 75px; border: solid 1px grey; text-align: center; ">UNI</td>
        <td style="width: 75px; border: solid 1px grey; text-align: center;"><?= $valor_km ?></td>
        <td style="width: 75px; border: solid 1px grey;text-align: center; ">0</td>
        <td style="width: 75px; border: solid 1px grey;text-align: center; "><?= $valor_km ?></td>
    </tr>
 </table>
...
<div class="container">
    ...
    <div class="row" style="width: 50%;  float:right">
           <div style="width: 70%; text-align: right; float:left">SUBTOTAL 12%:</div><div style="text-align: right"> <?= $valor_km ?></div>
           ...
           <div style="width: 70%; text-align: right; float:left">SUBTOTAL SIN IMPUESTOS:</div><div style="text-align: right"> <?= $valor_km ?></div>
...
<table>    
    ...
    <tr>
        ...
        <td style="width: 50px; border: solid 1px grey;"><?= $valor_km ?></td>
